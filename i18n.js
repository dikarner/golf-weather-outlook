const de = {
  ...
  golfInfoBody:
    "Wenn Golfplatz an ist, zeigt dieser Ort die Karte „Runde – Wetterprognose“: Abschlagzeit und ein 5-Stunden-Fenster. Für ein Dorf oder zuhause das Häkchen auslassen — dann fällt der Rundenblock weg und die Prognose hat mehr Platz.",
...
const en = {
  ...
  golfInfoBody:
    "When Golf course is on, this place shows the “Round – weather forecast” card: tee time and a 5-hour window. For a village or home, leave it off — the round block disappears and the outlook has more room.",
