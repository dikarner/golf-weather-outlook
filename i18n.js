const de = {
  ...
  useGpsHint: "Ersetzt die Suchposition durch den Standort dieses Geräts, wenn Sie dort stehen.",
  gpsPicked: "GPS: {name}",
  gpsMoved: "GPS übernommen · {dist} vom bisherigen Pin",
  ...
  close: "Schließen",
  placesHint:
    "Golfplätze oder Orte. Jedes Gerät speichert getrennt (auch Safari und die Home-Screen-App). Sichern, Datei auf das andere Gerät schicken (AirDrop), dann Laden.",
  exportPlaces: "Sichern",
  importPlaces: "Laden",
  exportShared: "Teilen — z. B. AirDrop auf den Mac, dort Laden.",
...
const en = {
  ...
  useGps: "Use GPS",
  useGpsHint: "Replaces the search pin with this device’s location when you are standing there.",
  gpsPicked: "GPS: {name}",
  gpsMoved: "GPS saved · {dist} from the previous pin",
  refresh: "Refresh",
  round: "Round",
  ...
  close: "Close",
  placesHint:
    "Golf courses or villages. Each device stores its own list (Safari and the home-screen app too). Export, send the file to the other device (AirDrop), then Import.",
  exportPlaces: "Export",
  importPlaces: "Import",
  exportShared: "Share — e.g. AirDrop to the Mac, then Import there.",
